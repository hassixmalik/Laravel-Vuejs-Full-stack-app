...
type ProductOption = { label: string; value: number; price: number; stock: number }
          ...
          <div class="grid grid-cols-12 gap-3" v-for="(it, idx) in form.items" :key="idx">
              ...
              <p class="text-xs mt-1" :class="lineExceedsStock(idx) ? 'text-red-600' : 'text-gray-500'">
                <template v-if="it.product_id">
                  <template v-if="lineExceedsStock(idx)">
                    Requested qty exceeds stock ({{ productStock(it.product_id) }}). Reduce quantity.
                  </template>
                  <template v-else>
                    available
                  </template>
            ...
            <div class="col-span-3">
              ...
              <Input
                ...
                min="0"
                step="0.001"
                :value="Number(it.unit_total ?? 0).toFixed(3)"
                placeholder="0.000"
                disabled
              />
        ...
        <div class="grid grid-cols-3 gap-4">
          <div>
            ...
            <SearchableSelect
              ...
              :options="page.props.customerOptions"
